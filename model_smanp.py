...
"""
实现spatial multi-attention Conditional Neural Process
"""
...
# class LatenEncoder(nn.Module):
#     """
#     Latent Encoder [z]
#     """
#
#     def __init__(self, x_size, y_size, num_hidden):
#         super(LatenEncoder, self).__init__()
...
class SpatialNeuralProcess(nn.Module):
    def __init__(self, x_size, y_size, num_hidden):
        ...
        # self.LatentEncoder = LatenEncoder(self.x_size, self.y_size, self.num_hidden)
    ...
    def forward(self, context_x, context_y, target_x):
        """ context_x : (batch_size, n_context, x_size)
            ...
            target_x : (batch_size, n_target, x_size)
        """
        # z, prior_mu, prior_sigma = self.LatentEncoder(context_x, context_y, target_x)  # latent Encoder
        ...
        # return prior_mu, prior_sigma, mu, sigma  #latent encoder
        return mu, sigma    #no latent encoder
...
class Criterion(nn.Module):
    ...
    # def forward(self, prior_mu, prior_sigma, mu, sigma, target_y):  #latent
